    ...
    <div className="flex flex-col items-center justify-center h-full  ">
      ...
      <div className="bg-white p-6 mx-auto w-[90%] rounded-lg shadow-[0px_-8px_38px_-9px_rgba(0,_0,_0,_0.3)]  max-w-lg border border-[#0e86bdcf] ">
        <div className="space-y-4">
          <div className="flex justify-betwxeen text-gray-600">
          ...
          <div className="flex justify-between text-[#0e86bdcf]">
          ...
          <div className="flex space-x-2 mt-4">
            <input
              ...
              className="w-full px-3 py-2 border text-[#0e86bdcf] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              readOnly
            />
            <button className="bg-[#0e86bdcf] text-white px-4 py-2 rounded-md ">
              Paynow
            </button>
          </div>
        </div>
